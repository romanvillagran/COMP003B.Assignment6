...
namespace COMP003B.Assignment6.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        {
            ViewData["MovieId"] = new SelectList(_context.Movies, "Id", "Director");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Content,Rating,MovieId")] Review review)
        {
            ...
            ViewData["MovieId"] = new SelectList(_context.Movies, "Id", "Director", review.MovieId);
            return View(review);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Content,Rating,MovieId")] Review review)
        {
            if (id != review.Id)
            {
                return NotFound();
